...
import { Card, CardContent, Typography, Box, Grid, TextField, Button, CircularProgress, Alert } from '@mui/material';
            ...
            <Grid item xs={12} sm={6}>
              <CategorySelect
                ...
                onAddCategory={(catName) => {
                  // Call backend to add category, then refresh categories
